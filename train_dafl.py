...
parser.add_argument('--cond', type=float, default=10, help='conditional loss')
parser.add_argument('--ie', type=float, default=0, help='information entropy loss')
parser.add_argument('--a', type=float, default=0.5, help='activation loss')
parser.add_argument('--kd', type=float, default=5, help='knowledge distillation loss')
